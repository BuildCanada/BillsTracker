...
export const mockBillResponses: Record<string, ApiBillDetail> = {
  "S-230": {
    ...
    header:
      "This enactment requires the Minister of Agriculture and Agri-Food to develop a national strategy",
    summary:
      "This enactment requires the Minister of Agriculture and Agri-Food to develop a national strategy to support and promote efforts across Canada to protect, conserve and enhance the health of soil.",
    ...
    sessionNumber: 1,
    source:
      "https://www.parl.ca/Content/Bills/451/Private/S-230/S-230_1/S-230_E.xml",
  },
  "S-231": {
    billID: "S-231",
    ...
    summary:
      "This enactment amends the Canada Business Corporations Act to provide corporate transparency.",
    ...
    sessionNumber: 1,
    source:
      "https://www.parl.ca/Content/Bills/451/Private/S-231/S-231_1/S-231_E.xml",
  },
  "C-208": {
    billID: "C-208",
    title:
    ...
    summary:
      "This enactment amends the Income Tax Act to provide for intergenerational business transfers.",
    ...
    sessionNumber: 1,
    source:
      "https://www.parl.ca/Content/Bills/451/Private/C-208/C-208_1/C-208_E.xml",
  },
  "C-206": {
    billID: "C-206",
    ...
    summary:
      "This enactment amends the Greenhouse Gas Pollution Pricing Act to provide exemptions for farmers.",
    ...
    sessionNumber: 1,
    source:
      "https://www.parl.ca/Content/Bills/451/Private/C-206/C-206_1/C-206_E.xml",
  },
};

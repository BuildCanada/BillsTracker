...
type QuestionSubset = Pick<UnifiedBill, "billId" | "title" | "short_title" | "final_judgment" | "isSocialIssue"> & {
  question: string;
  index: number;
  fallbackId?: string;
};
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 16, height: "100%" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ fontSize: 36, fontWeight: 800, color: "#0f172a", letterSpacing: -0.5 }}>Question {bill.index}</div>
            <div style={{
              display: "flex",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, flex: 1, justifyContent: "center" }}>
            <div style={{ maxWidth: 1040, fontSize: 44, fontWeight: 700, lineHeight: 1.15, color: "#0f172a", wordBreak: "break-word" }}>
              {title}
            </div>
            <div style={{ maxWidth: 1040, fontSize: 28, color: "#334155", lineHeight: 1.4, marginTop: 12, wordBreak: "break-word" }}>
              {bill.question}
            </div>
          </div>

          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ fontSize: 18, color: "#6b7280" }}>Question Period</div>

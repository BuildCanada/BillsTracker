...
export const Markdown = ({ children }: { children: React.ReactNode }) => {
  return <ReactMarkdown
    ...
    components={{
      ...
      h2: ({ children }: { children: React.ReactNode }) => <h2 className="text-base font-semibold   mb-2 mt-3 first:mt-0">{children}</h2>,
      h3: ({ children }: { children: React.ReactNode }) => <h3 className="text-sm font-medium leading-14   mb-2 mt-3 first:mt-0">{children}</h3>,
      ...
      code: ({ children }: { children: React.ReactNode }) => <code className="bg-[var(--chip-bg)]   px-1 py-0.5 rounded text-xs font-mono">{children}</code>,

  ...
  return (
    <>
      <button
        ref={buttonRef}
        type="button"
        className="mt-3 inline-block text-xs underline text-[var(--muted)]"
        onClick={openModal}
      >
        FAQ
      </button>
      ...
      {mounted && (
        ...
        >
          ...
          <div
            ...
            tabIndex={-1}
            className={`relative z-10 w-full max-w-2xl rounded-lg border border-[var(--panel-border)] bg-[var(--panel)] p-5 shadow-xl outline-none transition-all duration-200 ease-out ${visible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-2 scale-95"
              }`}
          >
            <div className="flex items-start justify-between">
              ...
              <button
                type="button"
                aria-label="Close"
                className="ml-3 rounded text-[var(--muted)] hover:text-black/80"
                onClick={closeModal}
              >
                ✕
              </button>
            ...
            <div className="mt-4 text-sm leading-6">
              ...
              <h3 className="font-semibold mt-4">Where do commitments come from?</h3>
              <p className="text-[var(--muted)] mt-1">
              ...
              <h3 className="font-semibold mt-4">Where do metrics and targets come from?</h3>
              <p className="text-[var(--muted)] mt-1">
              ...
              <h3 className="font-semibold mt-4">How are the progress, impact, and alignment scores calculated?</h3>
              <p className="text-[var(--muted)] mt-1">
                We use an LLM to score each of these. Our project is open sourced on <a className="underline" href="https://github.com/build-canada/outcomes" target="_blank" rel="noreferrer">Github</a>.
              </p>

              <h3 className="font-semibold mt-4">How can I contribute?</h3>
              <p className="text-[var(--muted)] mt-1">
                This is a work in progress and we would love help from others. Join us on <a className="underline" href="https://discord.gg/7rQ3VjYQea" target="_blank" rel="noreferrer">Discord</a>.
              </p>

              <h3 className="font-semibold mt-4">How can I get in touch?</h3>
              <p className="text-[var(--muted)] mt-1">
                You can reach out to us at <a className="underline" href="mailto:hi@buildcanada.com">hi@buildcanada.com</a>
              </p>
            </div>
          </div>
        </div>

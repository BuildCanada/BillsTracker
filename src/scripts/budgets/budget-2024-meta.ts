export const BUDGET_2024_META = {
  ...
  // Dates
  introducedOn: new Date("2024-04-16"), // Date when budget was introduced/tabled
  lastUpdatedOn: new Date("2024-04-16"), // Date of last update (typically same as introducedOn for budgets)

  // Additional metadata
  genres: ["Budget"], // Categories/tags for the bill
  supportedRegion: "Canada", // Geographic scope
  source: "https://www.budget.canada.ca/2024/home-accueil-en.html", // Official source URL
